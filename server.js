...
app.use(bodyParser.json()); // parse the content-type application/JSON
app.use(bodyParser.urlencoded({ extended: true })); // parse the content-type application/x-www-form-urlencoded
